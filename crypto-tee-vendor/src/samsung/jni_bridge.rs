...
impl KnoxJniContext {
    ...
    pub fn is_knox_available(&self, env: &mut JNIEnv) -> VendorResult<bool> {
        ...
        Ok(api_level.i().unwrap_or(0) >= 30) // Knox 3.0 or higher
    }
    ...
    pub fn generate_key(
        ...
        let builder = unsafe {
            env.new_object_unchecked(
                builder_class,
                builder_constructor,
                &[JValue::Object(&alias_jstring).as_jni(), JValue::Int(purposes).as_jni()],
            )
        }
        ...
        unsafe {
            env.call_method_unchecked(
                ...
                &[JValue::Object(&algorithm_jstring).as_jni()],
        ...
        let key_generator = unsafe {
            env.call_static_method_unchecked(
                key_generator_class,
                get_instance_method,
                &[JValue::Object(&algorithm_jstring).as_jni(), JValue::Object(&provider_jstring).as_jni()],
                jni::signature::ReturnType::Object,
            )
        }
        .map_err(|e| {
        ...
        if let Ok(spec_obj) = spec.l() {
            let key_gen_obj = key_generator.l().unwrap();
            unsafe {
                env.call_method_unchecked(
                    &key_gen_obj,
                    init_method,
                    &[JValue::Object(&spec_obj).as_jni()],
    ...
    pub fn sign_data(&self, env: &mut JNIEnv, alias: &str, data: &[u8]) -> VendorResult<Vec<u8>> {
        ...
        let keystore = unsafe {
            env.call_static_method_unchecked(
                keystore_class,
                get_instance_method,
                &[JValue::Object(&provider_jstring).as_jni()],
                jni::signature::ReturnType::Object,
            )
        }
        .map_err(|e| {
        ...
        let key = unsafe {
            env.call_method_unchecked(
                &keystore_obj,
                get_key_method,
                &[JValue::Object(&alias_jstring).as_jni(), JValue::Object(&null_obj).as_jni()],
                jni::signature::ReturnType::Object,
            )
        }
        ...
        if let Ok(key_obj) = key.l() {
            ...
            unsafe {
                env.call_method_unchecked(
                    &sig_obj,
                    update_method,
                    &[JValue::Object(&data_array).as_jni()],
                    jni::signature::ReturnType::Primitive(jni::signature::Primitive::Void),
                )
            }
    ...
    pub fn get_attestation(&self, env: &mut JNIEnv, alias: &str) -> VendorResult<Vec<Vec<u8>>> {
        ...
        let cert_chain = unsafe {
            env.call_method_unchecked(
                ...
                &[JValue::Object(&alias_jstring).as_jni()],
                jni::signature::ReturnType::Array,
            )
        }
        .map_err(|e| {
